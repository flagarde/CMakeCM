...
function(missive)
  ...
  if(NOT ${MISSIVE_MODE_FOUND} STREQUAL "-1")
    ...
    message(${PARENT_MODE} ${${APPEND_STYLE_BEGIN}} ${APPEND_BEGIN} ${Reset} ${${STYLE}} ${STRING_ARGV} ${Reset} ${${APPEND_STYLE_END}} ${APPEND_END}${Reset})
  else()
    message(${ARGV})
  endif()
endfunction()

if(NOT NOT_REDEFINE_CMAKE_MODES AND CMAKE_VERSION VERSION_LESS_EQUAL 3.21)
  missive_mode(NAME "FATAL_ERROR" STYLE "Red")
  missive_mode(NAME "SEND_ERROR" STYLE "Red")
  missive_mode(NAME "WARNING" STYLE "Yellow")
  missive_mode(NAME "AUTHOR_WARNING" STYLE "Yellow")
  missive_mode(NAME "DEPRECATION" STYLE "White")
endif()
