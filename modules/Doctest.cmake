...
if(CMAKE_CURRENT_SOURCE_DIR STREQUAL CMAKE_SOURCE_DIR)
 ...
 if(NOT DEFINED DEFAULT_CTEST_CONFIGURATION_TYPE)
    missive(WARN "You have not included Doctest module in the source directory root \"${CMAKE_SOURCE_DIR}/CMakeLists.txt\" and you didn't call CTest neither in this directory.")
    missive(WARN "You should call CTest in ${CMAKE_SOURCE_DIR}/CMakeLists.txt or include Doctest directly in it.")
    include(CTest)
 endif()
endif()
