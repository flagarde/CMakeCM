...
function(list_third_party_licenses FILENAME)
  ...
  add_custom_target(CPMLicenses ALL "" DEPENDS write-license BYPRODUCTS "${CMAKE_CURRENT_BINARY_DIR}/${FILENAME}" COMMENT "Generating the third-party licenses list in ${FILENAME}")
