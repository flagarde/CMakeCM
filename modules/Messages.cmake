...
if(NOT NOT_REDEFINE_CMAKE_MODES)
  ...
  message_mode(NAME "DEPRECATION" STYLE "Yellow")
endif()
...
if(NOT NOT_DEFINE_MODES)
  ...
  message_mode(NAME "ERROR_UNICODE" STYLE "BoldRed" APPEND_BEGIN "❗ " APPEND_END " ❗ " APPEND_STYLE "BoldRed")
  message_mode(NAME "WARN_UNICODE" STYLE "BoldYellow" APPEND_BEGIN "⚠️ " APPEND_END " ⚠️  " APPEND_STYLE "BoldYellow")
  message_mode(NAME "TODO" STYLE "Blue" PARENT_SCOPE "DEBUG" APPEND_BEGIN "🔨 " APPEND_END " 🔨  " APPEND_STYLE "Blue")
  message_mode(NAME "SUCCESS" APPEND_BEGIN "✅ " STYLE "Green")
  message_mode(NAME "FAILURE" APPEND_BEGIN "❌ " STYLE "Red")
endif()
