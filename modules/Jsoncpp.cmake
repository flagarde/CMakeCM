...
if(${USE_SYSTEM_JSONCPP})
  ...
  if(jsoncpp_FOUND)
    ...
    missive(NOTE "jsoncpp not found ! jsoncpp will be compiled using ${JSONCPP_REPOSITORY} version ${JSONCPP_VERSION} !")
  endif()
else()
  set(COMPILE_JSONCPP TRUE)
  if(NOT jsoncpp_ADDED)
    missive(NOTE "jsoncpp will be compiled using ${JSONCPP_REPOSITORY} version ${JSONCPP_VERSION}.")
  endif()
endif()
