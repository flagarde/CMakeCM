...
if(COMPILE_OPENSSL)
  ...
  if(OpenSSL-CMake_ADDED)
    ...
    elseif(${CMAKE_CXX_COMPILER_ID} MATCHES "Clang")
      target_compile_options(crypto PRIVATE "-Wno-old-style-cast -Wno-sign-conversion -Wno-covered-switch-default -Wno-padded")
      target_compile_options(ssl PRIVATE "-Wno-old-style-cast -Wno-sign-conversion -Wno-covered-switch-default -Wno-padded")
    endif()
