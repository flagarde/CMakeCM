...
if(COMPILE_ZLIB)
  ...
  if(zlib-ng_ADDED)
    ...
    elseif(${CMAKE_CXX_COMPILER_ID} MATCHES "Clang")
      target_compile_options(zlib PRIVATE "-Wno-cast-qual -Wno-cast-align -Wno-padded -Wno-sign-conversion")
      target_compile_options(zlibstatic PRIVATE "-Wno-cast-qual -Wno-cast-align -Wno-padded -Wno-sign-conversion")
    endif()
